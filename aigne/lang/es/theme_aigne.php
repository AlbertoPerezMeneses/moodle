...
$string['usermenu'] = 'En el Encabezado, al estilo del nuevo menú del usuario (login + menú desplegable)';
$string['usermoodle'] = 'En el Encabezado, al estilo antiguo de moodle (login + usuario + logout)';
