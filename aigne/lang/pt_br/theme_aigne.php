...
$string['metadescription'] = 'Bem-vindo à {$a->sitename}.';
/* ----- ----- ----- -> STRINGS DOS QUADROS DE INFORMAÇÃO NA FRONTPAGE ----- */
$string['moreinfo'] = 'Saber mais... ';
/* Strings do banner superior */
$string['banner1txt'] = 'Escreva aqui o texto do banner';
$string['banner1ttl'] = 'Escreva aqui o título do banner';
$string['banner1alt'] = 'Escreva aqui o texto alternativo da imagem do banner';
/* Strings da mensagem estática */
$string['frontmsgtxt'] = 'Aqui pode introduzir uma mensagem de acolhida<br />
...
$string['frontmsgttl'] = 'Escreva aqui o título da mensagem';
/* Strings dos quadros de informação */
$string['quadro1txt'] = '
<h2>Cuadros de texto:</h2>
Aqui puede introduzir cualquier información<br /><br />
Escreva un texto en su editor HTML favorito, a continuación entre en el archivo del idioma 
...
$string['quadro1ttl'] = 'Escreva aqui o título del cuadro 1';
$string['quadro1alt'] = 'Escreva aqui o texto alternativo de la imagen del cuadro 1';
$string['quadro2txt'] = '
<h2>Cuadros de texto:</h2>
Aqui puede introduzir cualquier información<br /><br />
Escreva un texto en su editor HTML favorito, a continuación entre en el archivo del idioma 
...
$string['quadro2ttl'] = 'Escreva aqui o título del cuadro 2';
$string['quadro2alt'] = 'Escreva aqui o texto alternativo de la imagen del cuadro 2';
$string['quadro3txt'] = '
<h2>Cuadros de texto:</h2>
Aqui puede introduzir cualquier información<br /><br />
Escreva un texto en su editor HTML favorito, a continuación entre en el archivo del idioma 
...
<strong>Puede darle el formato CSS que quiera en el archivo aigne_style.css</strong>';
$string['quadro3ttl'] = 'Escreva aqui o título del cuadro 3';
$string['quadro3alt'] = 'Escreva aqui o texto alternativo de la imagen del cuadro 3';
...
$string['aco5alt1'] = 'Escreva aqui o texto alternativo da imagem do fol 1';
$string['aco5alt2'] = 'Escreva aqui o texto alternativo da imagem do fol 2';
$string['aco5alt3'] = 'Escreva aqui o texto alternativo da imagem do fol 3';
$string['aco5alt4'] = 'Escreva aqui o texto alternativo da imagem do fol 4';
$string['aco5alt5'] = 'Escreva aqui o texto alternativo da imagem do fol 5';
...
$string['sli5alt1'] = 'Escreva aqui o texto alternativo da imagem da diapositiva 1';
$string['sli5alt2'] = 'Escreva aqui o texto alternativo da imagem da diapositiva 2';
$string['sli5alt3'] = 'Escreva aqui o texto alternativo da imagem da diapositiva 3';
$string['sli5alt4'] = 'Escreva aqui o texto alternativo da imagem da diapositiva 4';
$string['sli5alt5'] = 'Escreva aqui o texto alternativo da imagem da diapositiva 5';
/* Strings del acordeón aigne de información */
$string['acoacap1'] = 'Raya jamanta _ Texto do fole 1';
$string['acoacap2'] = 'Tiburón _ Texto do fole 2';
$string['acoacap3'] = 'Pulpo _ Texto do fole 3';
$string['acoacap4'] = 'Pescado _ Texto do fole 4';
$string['acoacap5'] = 'Buceo _ Texto do fole 5';
$string['acoaalt1'] = 'Escreva aqui o texto alternativo da imagem do fol 1';
$string['acoaalt2'] = 'Escreva aqui o texto alternativo da imagem do fol 2';
$string['acoaalt3'] = 'Escreva aqui o texto alternativo da imagem do fol 3';
$string['acoaalt4'] = 'Escreva aqui o texto alternativo da imagem do fol 4';
$string['acoaalt5'] = 'Escreva aqui o texto alternativo da imagem do fol 5';
$string['acoainfo1'] = 'Escreva aqui a informação que desejar transmitir no fol 1';
$string['acoainfo2'] = 'Escreva aqui a informação que desejar transmitir no fol 2';
$string['acoainfo3'] = 'Escreva aqui a informação que desejar transmitir no fol 3';
$string['acoainfo4'] = 'Escreva aqui a informação que desejar transmitir no fol 4';
$string['acoainfo5'] = 'Escreva aqui a informação que desejar transmitir no fol 5';
/**/
$string['newsinfo'] = 'Informação acadêmica';
$string['newsinfo1'] = '
<h2 style="text-align: center">Você esta na página modelo 1</h2>
<p>&nbsp;</p>
<p>Pode criar uma página HTML com toda a informação interesante sobre os seus cursos.</p>
<p>&nbsp;</p>';
$string['newsinfo2'] = '
<h2 style="text-align: center">Você esta na página modelo 2</h2>
<p>&nbsp;</p>
<p>Pode criar uma página HTML com toda a informação interesante sobre os seus cursos.</p>
<p>&nbsp;</p>';
$string['newsinfo3'] = '
<h2 style="text-align: center">Você esta na página modelo 3</h2>
<p>&nbsp;</p>
<p>Pode criar uma página HTML com toda a informação interesante sobre os seus cursos.</p>
<p>&nbsp;</p>';
$string['newsinfo4'] = '
<h2 style="text-align: center">Você esta na página modelo 4</h2>
<p>&nbsp;</p>
<p>Pode criar uma página HTML com toda a informação interesante sobre os seus cursos.</p>
<p>&nbsp;</p>';
$string['newsinfo5'] = '
<h2 style="text-align: center">Você esta na página modelo 5</h2>
<p>&nbsp;</p>
<p>Pode criar uma página HTML com toda a informação interesante sobre os seus cursos.</p>
<p>&nbsp;</p>';
...
$string['contactlink'] = 'Contate com nós: ';
$string['fisicallink'] = 'Venha ao nosso endereço: ';
$string['sociallinks'] = '... e nas Redes Sociais: ';
$string['sendemailsubj'] = 'Informação sobre {$a} ';
$string['sendemailtitle'] = '::: enviar um eMail ao administrador do web site :::';
...
<p>&nbsp;</p>
<p>Aqui puede crear un mapa con la estructura de páginas que necesita
...
<h2>Ayuda a la navegación:</h2>
  <p>Aqui puede introduzir todas las referencias necesarias para facilitar la 
...
<p>&nbsp;</p>
<h2>Buscar:</h2>
  <p>Aqui puede introduzir herramientas generales de búsqueda.</p>
  <p>&nbsp;</p>';
$string['statspage'] = '
<h2 style="text-align: center">Você esta em uma página modelo</h2>
<p>&nbsp;</p>
<h2>Estadísticas:</h2>
  <p>Aqui puede introduzir los resultados de estadísticas de navegación o 
...
<h2>Politicas do sitio:</h2>
  <p>Aqui puede introduzir las políticas de uso do sitios web, los deberes y derechos 
     de los alumnos, .</p>
  <p>&nbsp;</p>';
$string['privacypage'] = '
<h2 style="text-align: center">Você esta em uma página modelo</h2>
...
<p>Aqui puede introduzir la información sobre la privacidad de los datos na navegación 
...
<p>&nbsp;</p>
<h2>Seguridad:</h2>
<p>Aqui puede introduzir las medidas de seguridad que se utilizan para prevenir el SPAM, 
...
<p>&nbsp;</p>
<h2>Accesibilidad</h2>
<p>Aqui puede introduzir las herramientas que estan instaladas no sitio web para 
...
Se você quiser mantener el color original, seleccione el blanco o Escreva #FFFFFF.';
...
Seleccione aqui ese intervalo, e se aborrece ese efecto, seleccione a primeira opción. 
...
$string['custommtagdesc'] = 'Se você quiser personalizar al máximo, puede añadir aqui las Meta Etiquetas que necesita.<br />
...
$string['sitenewsi'] = 'Mostrar o autor e as opções nas "Novidades"';
$string['sitenewsidesc'] = 'En caso afirmativo, mostraráse a información do autor e as opções en cada unha das "Novidades" (Forum)';
/**/
...
$string['corpwebdesc'] = 'Digite aqui la dirección web de su Organización, Institución educativa o Empresa matriz. (ej.: http://www.dominio_empresa.es/) <br />
Esta dirección no tiene relación con ruta indicada en config.php';
$string['emailimg'] = 'Imagen para eMail';
$string['emailimgdesc'] = 'Aqui puede añadir uma imagem con la dirección eMail de soporte. Esto ayudará a prevenir que herramientas maliciosas de spam capturen su dirección eMail. <br />
...
$string['contactnotedesc'] = 'Aqui puede añadir información de contacto que aparecerá en medio da zona de contacto do rodapé da página';
$string['maplink'] = 'Link para un Mapa';
$string['maplinkdesc'] = 'Digite o link do mapa com o endereço da sua instituição. (ex. google maps / bing maps).';
/**/
...
$string['social1urldesc'] = 'Aqui pode introduzir a ligazón dunha rede social que non esta no listado definido anteriormente.';
...
$string['footnoteshow'] = 'Mostrar nota de rodapé';
$string['footnoteshowdesc'] = 'Se deseja mostrar o conteúdo da Nota de rodapé, definida no seguinte quadro, ative esta opção.';
...
$string['copyrightstgdesc'] = 'Aqui puede escribir el mensaje que aparecerá al final do rodapé da página, describiendo la propiedad do sitio Web. 
